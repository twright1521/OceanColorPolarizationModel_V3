...
sim_num = 601;        %Simulation Folder Number - can be a vector of simulation numbers

% Angles to Plot
% Should be found in the respective angle files used to create input files
Sun_Zen = 60;       % Sun polar angle, degrees                   
...
for sim_idx = 1:length(sim_num)
    ...
    %                         num2str(Rec_Azm(rec_azm_idx)),'.mat'),'Sim_Data_Cell')
                ...
                clearvars -except sim_num Sun_Zen Rec_Zen Rec_Azm plot_vars m n sim_fol_name filename sun_zen_idx rec_zen_idx rec_azm_idx fignum 
            end
        end
    end
end